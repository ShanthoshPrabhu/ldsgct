...
const Payment = () => {
  ...
  async function getUsers() {
    ...
    getDocs(userRef).then((snapshot) => {
      ...
      const usercheck = value?.filter(
        (filteredusers) => filteredusers?.sessionemail == session?.user?.email
      );
  ...
  async function uploadData() {
    ...
    const imageRef = ref(
      storage,
      `payments/${session?.user.email + fileName} `
    );
      ...
      <div className="flex items-center justify-center min-h-screen mt-16 bg-white">
        <div className="container">
          ...
          <div class=" text-center pt-4 lg:px-4 rounded-lg w-lg mt-6">
            <div
              class="p-2 bg-yellow-600 items-center text-white leading-none rounded-lg flex lg:inline-flex mx-10 md:mx-0"
              role="alert"
            >
              <span class="flex rounded-full bg-gray-800 uppercase px-2 py-1 text-xs font-bold mr-3">
                Pay
              </span>
              <span class="font-semibold mr-2 text-left flex-auto">
                !!Use any one of the below payment methods to pay the
                registration fee of Rs. 180. Once the payment is done, take a
                screenshot of the payment in a manner that the transaction ID is
                visible clearly (example given below). Upload the screenshot
                here.
              </span>
              <svg
          ...
          <div className="grid justify-around grid-flow-row md:grid-flow-col">
            <div className="grid justify-center grid-flow-row cursor-pointer md:grid-flow-row gap-y-24 md:gap-x-24 mt-14 md:mt-10 ">
              <div className="flex flex-col items-center justify-center h-48 p-6 mx-12 bg-gray-800 border rounded-lg shadow-md shadow-yellow-500 sm:h-56 w-72 sm:w-96 ">
                ...
                <div className="mt-4 font-light text-center text-yellow-500">
              ...
              <div className="flex flex-col items-center justify-center h-48 mx-12 bg-gray-800 border rounded-lg shadow-md shadow-yellow-500 sm:h-56 w-72 sm:w-96">
                <div className="mb-4 text-xl font-light text-center text-yellow-500">
                  89252 34490
                </div>
                <div className="h-10 font-bold text-center text-yellow-500">
                  Pay through Phone Number
                </div>
                <div className="h-10 font-light text-center text-white">
                  You can pay the registration fee to this number
                </div>
                <div className="h-10 font-light text-center text-white">
                  Incase of any server error pay through this alternative
                  number:8110052002
                </div>
              </div>
            </div>
            <div className="grid justify-center grid-flow-row cursor-pointer md:grid-flow-row gap-y-24 md:gap-x-24 mt-14 md:mt-10">
              <div className="flex flex-col items-center justify-center h-48 p-10 mx-12 bg-gray-800 border rounded-lg shadow-md shadow-yellow-500 sm:h-56 w-72 sm:w-96">
                <input
                  ...
                  className="mx-auto text-yellow-500 md:mx-auto md:ml-8"
                />
                <button
                ...
                {showToast && (
                  <div className="fixed p-4 mb-4 mr-4 text-white bg-gray-800 rounded-lg shadow-lg bottom-20">
                    <p>
                      Thanks for Registering, we will contact you after
                      verifying.
                    </p>
                  </div>
                )}
              ...
              <div className="flex flex-col items-center justify-center p-10 mx-12 bg-gray-800 border rounded-lg shadow-md shadow-yellow-500 w-[280px] md:w-[300px] h-120">
                <img
                  src="https://www.linkpicture.com/q/IMG-20230214-WA0002.jpg"
                  alt="verfication"
                  height="100"
                  width="200"
                />
                <p className="mt-2 text-xl font-normal text-center text-yellow-500">
                  Upload your payment screenshot for verification with you UPI
