    ...
    <div>
      ...
      <div className='grid mt-20 mb-20 md:grid-cols-3 '>
         <div className="flex-col items-center justify-center col-span-2 px-10 text-lg font-light leading-loose ">
          <p className=""><span className="text-yellow-600  font-normal ml-10">O</span>ne of Coimbatores largest events dedicated solely to celebrating the love of the English Language and its rich literature is back and ready to be the literary festival that will leave you in awe.
